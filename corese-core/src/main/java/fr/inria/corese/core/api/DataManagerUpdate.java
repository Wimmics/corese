...
/**
 * Interface to corese graph OR external graph implementation For sparql update
 */
public interface DataManagerUpdate {
    ...
    /**
     * If Edge have a named graph: delete this occurrence Otherwise: delete all
     * occurrences of edge Return list of deleted edge
     */
     ...
     * occurrences edge has no named graph Return list of deleted edges
     * 
