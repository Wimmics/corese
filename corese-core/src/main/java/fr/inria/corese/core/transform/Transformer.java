...
public class Transformer implements TransformProcessor {
    ...
    /**
     * Returns the transformed string generated by the Transformer.
     *
     * If an EngineException occurs, the exception message and AST (if not null)
     * will be logged, and an empty string will be returned.
     *
