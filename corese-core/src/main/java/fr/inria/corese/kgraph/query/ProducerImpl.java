...
import fr.inria.corese.kgtool.util.ValueCache;
...
public class ProducerImpl implements Producer, IProducerQP {
	...
	/**
	 * Iterator of Entity that performs local Ontology match.match() Enable
	 * to have a local ontology in case of several graphs with local
