...
import fr.inria.corese.kgtool.load.rdfa.RDFaLoader;
import java.io.File;
...
import fr.inria.corese.kgtool.load.jsonld.CoreseJsonTripleCallback;
import fr.inria.corese.kgtool.load.jsonld.JsonldLoader;
import fr.inria.corese.kgtool.load.rdfa.CoreseRDFaTripleSink;
import fr.inria.corese.kgtool.load.sesame.ParserLoaderSesame;
import fr.inria.corese.kgtool.load.sesame.ParserTripleHandlerSesame;
