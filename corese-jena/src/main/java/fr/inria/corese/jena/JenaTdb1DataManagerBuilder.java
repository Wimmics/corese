...
public class JenaTdb1DataManagerBuilder implements DataManagerBuilder {
    ...
    /**
     * Builds a JenaTdb1DataManager object.
     *
     * If both a storage path and a Jena Dataset are set, a new data manager is created with these settings.
     * If only a storage path is set, a new data manager is created with the specified path.
     * If only a Jena Dataset is set, an IllegalArgumentException is thrown.
     * If neither a storage path nor a Jena Dataset is set, a new data manager is created in-memory.
     *
     * @return The built JenaTdb1DataManager object
     * 
