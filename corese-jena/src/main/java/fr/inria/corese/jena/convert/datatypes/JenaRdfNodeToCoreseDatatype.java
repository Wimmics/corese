...
/**
 * Converts Jena RDF nodes to equivalent Corese datatypes.
 *
 * The class facilitates conversion of various types of Jena RDF nodes such as URI resources, blank nodes,
 * and literals. For literal nodes, it checks the datatype of Jena literal and converts it to
 * corresponding Corese datatype while preserving any language tags if present. Additionally, it offers
 * methods to convert Jena Resources to Corese URI and blank nodes.
 *
...
public class JenaRdfNodeToCoreseDatatype {
    ...
    /**
     * Converts a Jena RDF node to a Corese datatype.
     *
     * @param jena_rdf_node The Jena RDF node to convert.
     * @return The equivalent Corese datatype.
     *
     * This docstring was generated by AI.
     */
