 ...
 * eval query and/or apply transformation (on query result) or execute a
 * Workflow and return HTML
 * 
...
public class Transformer {
    ...
    String protect(Param p, String ft) {
        fr.inria.corese.core.transform.Transformer t = fr.inria.corese.core.transform.Transformer.create(RESULT);
    ...
    String error(String err, String q) {
        String mes = "";
        // mes += "<html><head><link href=\"/style.css\" rel=\"stylesheet\"
