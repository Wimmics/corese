...
public class HttpsServerTest {
    private static final Logger logger = Logger.getLogger(HttpsServerTest.class.getName());
    ...
    public static void init() throws InterruptedException, IOException, Exception {
        ...
        // The server is launched using a bash script in
        // src/test/resources/launch_ssl_server.sh
        // The launch and shutdown operations are done by maven (see
        // corese_server/pom.xml).
        Thread.sleep(5000);
    }
