...
import fr.inria.corese.sparql.datatype.CoreseDateNew;
import fr.inria.corese.sparql.datatype.CoreseDateTimeNew;
import fr.inria.corese.sparql.datatype.CoreseDecimal;
import fr.inria.corese.sparql.datatype.DatatypeMap;
import fr.inria.corese.sparql.datatype.XSD;

public class CoreseDateNewTest {

    @Test
    public void testGetSecond() {
        CoreseDateNew corese_dt = (CoreseDateNew) DatatypeMap.newDateTimeNew("2021-07-20T10:00:00.12");
        assertEquals(new CoreseDecimal(0.12), corese_dt.getSecond());
    }

    @Test
    public void compareLessGreaterTimeZone() {
        IDatatype dt = DatatypeMap.newDateTimeNew("2002-10-10T12:00:00+00:00");

        IDatatype dt1 = DatatypeMap.newDateTimeNew("2002-10-10T12:00:00-06:00");
        IDatatype dt2 = DatatypeMap.newDateTimeNew("2002-10-10T12:00:00+00:00");
        IDatatype dt3 = DatatypeMap.newDateTimeNew("2002-10-10T12:00:00+06:00");
    ...
    public void compareLessGreater() {
        IDatatype dt = DatatypeMap.newDateTimeNew("2002-10-10T12:00:00");

        IDatatype dt1 = DatatypeMap.newDateTimeNew("2002-10-10T12:00:00.1");
        IDatatype dt2 = DatatypeMap.newDateTimeNew("2002-10-10T12:00:00");
        IDatatype dt3 = DatatypeMap.newDateTimeNew("2002-10-10T11:59:00.999");
    ...
    public void compareEqual() {
        IDatatype dt1 = DatatypeMap.newDateNew("2002-10-10T12:00:00");
        IDatatype dt2 = DatatypeMap.newDateNew("2002-10-10T12:00:00");
        IDatatype dt3 = DatatypeMap.newDateNew("2002-10-10T12:00:00.001");
    ...
    public void constructorEmpty() throws DatatypeConfigurationException {
        CoreseDateNew date = new CoreseDateNew();
    }

    @Test
    public void getCode() throws DatatypeConfigurationException {
        IDatatype date = DatatypeMap.newDateNew();
    ...
    public void getTZ() throws DatatypeConfigurationException {
        CoreseDateTimeNew date = (CoreseDateTimeNew) DatatypeMap.newDateTimeNew("2021-07-20T10:23:54.5");
        assertEquals(DatatypeMap.newLiteral(""), date.getTZ());

        date = (CoreseDateTimeNew) DatatypeMap.newDateTimeNew("2021-07-23T13:01:44Z");
        assertEquals(DatatypeMap.newLiteral("Z"), date.getTZ());

        date = (CoreseDateTimeNew) DatatypeMap.newDateTimeNew("2021-07-20T10:23:54.5-05:00");
        assertEquals(DatatypeMap.newLiteral("-05:00"), date.getTZ());

        date = (CoreseDateTimeNew) DatatypeMap.newDateTimeNew("2021-07-20T10:23:54.5+11:00");
