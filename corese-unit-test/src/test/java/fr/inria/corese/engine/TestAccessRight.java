...
public class TestAccessRight {
    ...
    public void test9() throws EngineException {
        ...
        AccessRightDefinition.getSingleton().getPredicate().define(NSManager.FOAF, AccessRight.RESTRICTED);

        access.getAccessRightDefinition().getPredicate().define(NSManager.FOAF + "knows", AccessRight.PUBLIC)
    ...
    public void test7() throws EngineException, LoadException {
        ...
        String q = "prefix h: <http://www.inria.fr/2015/humans#>" + "select * where { ?x h:age ?a }";
        ...
        String q2 = "prefix h: <http://www.inria.fr/2015/humans#>" + "select * where { ?x h:name 'John' }";
    ...
    public void test5() throws EngineException {
        ...
        access.setWhere(AccessRight.PRIVATE);
        AccessRight.setMode(AccessRight.EQ_MODE);
    ...
    public void test3() throws EngineException {
        ...
        // access.getAccessRightDefinition().getNode().define(NSManager.USER+"James",
        // AccessRight.PRIVATE);
