...
//        reqCtxt4.put(JAXWSProperties.HTTP_CLIENT_STREAMING_CHUNK_SIZE, 8192);
        ...
        exec.addRemote(new URL("http://localhost:8091/kgserver-1.0.6-kgram-webservice/RemoteProducerService.RemoteProducerServicePort"), WSImplem.SOAP);
        exec.addRemote(new URL("http://localhost:8092/kgserver-1.0.6-kgram-webservice/RemoteProducerService.RemoteProducerServicePort"), WSImplem.SOAP);
        exec.addRemote(new URL("http://localhost:8093/kgserver-1.0.6-kgram-webservice/RemoteProducerService.RemoteProducerServicePort"), WSImplem.SOAP);
        exec.addRemote(new URL("http://localhost:8094/kgserver-1.0.6-kgram-webservice/RemoteProducerService.RemoteProducerServicePort"), WSImplem.SOAP);
