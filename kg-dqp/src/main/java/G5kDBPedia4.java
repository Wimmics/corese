...
//                + "LIMIT 6";
    ...
    public static void main(String args[]) throws MalformedURLException, EngineException {
        ...
        File rep1 = new File("/home/agaignard/data/DBPedia-fragmentation/4-stores/persondata.1.1.rdf");
        File rep2 = new File("/home/agaignard/data/DBPedia-fragmentation/4-stores/persondata.1.2.rdf");
        File rep3 = new File("/home/agaignard/data/DBPedia-fragmentation/4-stores/persondata.2.1.rdf");
        File rep4 = new File("/home/agaignard/data/DBPedia-fragmentation/4-stores/persondata.2.2.rdf");
