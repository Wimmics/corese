...
public class MainFrame extends JFrame implements ActionListener {
	...
	private static final String TITLE = "Corese 3.2 - Wimmics INRIA I3S - 2017-09-21";
	...
	public void newQuery() {
		...
		/**
		 * ajoute le bouton de fermeture Juste après la création de
		 * l'onglet Query il y a donc 3 composants au conteneur d'onglet
		 * (Listener, Query, +) On différencie si c'est le 1er onglet
		 * créé ou non car le fait d'ajouter le croix fermante à
		 * l'onglet ajoute un composant au conteneur d'onglet (1 onglets
		 * = 1 composants onglet + 1 composant "croix fermante" = 2
		 * composants) mais ceci une seule fois (2 onglets = 2
		 * composants onglet + 1 composant "croix fermante" = 3
		 * composants) initTabComponent(0); appliquerait la croix
		 ...
		 * initTabComponent(conteneurOnglets.getComponentCount()-3); car
		 * il faut retirer la croix et l'onglet "+" dans le compte
		 */
...
//        myRadio.add(coreseBox);
	...
	/**
	 * permet de ranger un tableau selon l'ordre suivant 1)rdfs,owl 2)rul
	 * 3)rdf
	 *
	 * @param strArray
	 */
