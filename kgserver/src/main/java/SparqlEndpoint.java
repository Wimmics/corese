...
public class SparqlEndpoint {
    ...
    public static void main(String args[]) throws Exception {
        ...
        SparqlEndpoint depAll = new SparqlEndpoint(8083, SparqlEndpoint.class.getClassLoader().getResource("demographie").getPath()+"/cog-2012.ttl");
...
//          geo3.createServer();
        ...
        SparqlEndpoint s1 = new SparqlEndpoint(8087, SparqlEndpoint.class.getClassLoader().getResource("demographie").getPath()+"/s1.ttl");
...
//         s3.createServer();
        ...
        //demographic data
        SparqlEndpoint demo = new SparqlEndpoint(8091, SparqlEndpoint.class.getClassLoader().getResource("demographie").getPath()+"/popleg-2010.ttl");
//        demo.createServer();
    }
