...
/**
 * Root of external java function evaluator for SPARQL extension function
 * with JavaCompiler :
 * class Datashape extends Core 
 * environment and producer are set by Extern function call
 * 
