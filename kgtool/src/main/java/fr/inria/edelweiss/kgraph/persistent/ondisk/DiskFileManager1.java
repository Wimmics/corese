...
public class DiskFileManager1 {
    ...
    private static DiskFileManager1 manager;
    private LRUCacheFileHandler fileHandlers;

    private DiskFileManager1(String file) {
        try {
            if (file == null) {
            ...
            Logger.getLogger(DiskFileManager1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static DiskFileManager1 getInstance() {
        return getInstance(null, false);
    }

    public static DiskFileManager1 getInstance(String file, boolean newInstance) {
        if (newInstance || manager == null) {
            manager = new DiskFileManager1(file);
        }
...
//    }
    ...
    public void delete(Map<Integer, LiteralOnDiskMeta> toDelete, Map<Integer, LiteralOnDiskMeta> literalsOnDisk) {
        ...
        DiskFileManager1 newManager = new DiskFileManager1(null);
    ...
    public void closeConnection() {
        try {
            ...
            Logger.getLogger(DiskFileManager1.class.getName()).log(Level.SEVERE, "Close connection errors!", ex);
        }
    }
