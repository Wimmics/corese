...
public class FileHandlersManager extends LRUCache<Integer, FileHandler> {
    ...
    public FileHandlersManager(int capacity) {
        super(capacity);
    ...
    public FileHandler get(Object key) {
        //return the handler for writing
//        if (key == null || !(key instanceof Integer)) {
//            if(fhForWrite!=null && !fhForWrite.getChannel().isOpen()){
//                fhForWrite = getFileHandler(fhForWrite.getFid(), fhForWrite.getFname());
//            }
//            return fhForWrite;
//        }
        if (key == null || !(key instanceof Integer)) {
    ...
    private FileHandler getFileHandler(int fid, String file) {
        FileHandler fh = new FileHandler(fid, file);
        this.put(fid, fh);
        return fh;
    }
