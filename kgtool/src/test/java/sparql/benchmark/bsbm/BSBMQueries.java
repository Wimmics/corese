...
public class BSBMQueries {
    ...
    //private static final String Ex_Q09 = "PREFIX rev: <http://purl.org/stuff/rev#>  DESCRIBE ?x WHERE { <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/dataFromRatingSite1/Review7211> rev:reviewer ?x }";
    ...
    private static final String Ex_Q11 = "SELECT ?property ?hasValue ?isValueOf WHERE {   { <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/dataFromVendor5/Offer9801> ?property ?hasValue }   UNION   { ?isValueOf ?property <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/dataFromVendor5/Offer9801> } }";
    ...
    private static final String Bi_Q01 = ""
    ...
    private static final String Bi_Q04 = ""
            + "prefix bsbm: <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/>   \n"
            + "prefix bsbm-inst: <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/>   \n"
            + "prefix xsd: <http://www.w3.org/2001/XMLSchema#>    \n"
    ...
    private static final String Bi_Q05 = ""
            + "prefix bsbm: <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/>\n"
            + "  prefix bsbm-inst: <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/>\n"
            + "  prefix rev: <http://purl.org/stuff/rev#>\n"
            + "  prefix xsd: <http://www.w3.org/2001/XMLSchema#>\n"
    ...
    private static final String Bi_Q06 = "prefix bsbm: <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/>   \n"
            + "prefix bsbm-inst: <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/>   \n"
            + "prefix rev: <http://purl.org/stuff/rev#>   \n"
            + "prefix xsd: <http://www.w3.org/2001/XMLSchema#> \n"
            + "   \n"
            ...
            + "  ";
    private static final String Bi_Q07 = ""
            + "  prefix bsbm: <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/>\n"
            + "  prefix bsbm-inst: <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/>\n"
            + "  prefix xsd: <http://www.w3.org/2001/XMLSchema#>\n"
            + "\n"
            ...
            + "    }\n"
            + "  }";
    private static final String Bi_Q08 = "prefix bsbm: <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/>   \n"
            + "prefix bsbm-inst: <http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/>   \n"
            + "prefix xsd: <http://www.w3.org/2001/XMLSchema#>    \n"
