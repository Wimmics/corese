...
cd $(dirname $0) && mvn "-Dexec.args=-classpath %classpath fr.inria.wimmics.rdf_to_graph.app.App $1 $2 $3" -Dexec.executable=/usr/bin/java org.codehaus.mojo:exec-maven-plugin:1.2.1:exec
