package fr.inria.corese.rif.xml;
...
import fr.inria.corese.rif.ast.Group;
import fr.inria.corese.rif.ast.RIFDocument;
import fr.inria.corese.rif.xml.schema.Document;


public class RIFXMLParser {

	private static final String JAXB_CONTEXT_PACKAGE = "fr.inria.corese.rif.xml.schema" ;
