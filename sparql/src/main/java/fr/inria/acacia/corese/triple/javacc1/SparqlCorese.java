...
// @deprecated
  ...
  private int jj_gen;
  final private int[] jj_la1 = new int[299];
  ...
  public SparqlCorese(java.io.InputStream stream, String encoding) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 299; i++) jj_la1[i] = -1;
