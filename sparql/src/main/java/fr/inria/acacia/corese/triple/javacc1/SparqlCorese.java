...
// -------- Constraint syntax
  ...
  final public Term For(Exp stack) throws ParseException {
                        Term t; Expression exp, body ; Variable var; ExpressionList arg;
  ...
  final public Expression LetDef(Exp stack) throws ParseException {
                                 Variable var = null;   Expression exp ; ExpressionList el = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case VAR1:
    case VAR2:
      var = Var();
