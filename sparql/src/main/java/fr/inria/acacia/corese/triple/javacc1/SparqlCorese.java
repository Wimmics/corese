...
// by expanding out FunctionCall()
  ...
  final public Term Function(Exp stack) throws ParseException {
                             Term term;   ExpressionList v; Constant cst; Expression exp = null;
    ...
    jj_consume_token(RBRACE);
        term = astq.defineFunction(cst, v, exp );
    {if (true) return term;}
    throw new Error("Missing return statement in function");
  }
...
// return a blank that contains an array (aka pointer !)
  ...
  private int jj_gen;
  final private int[] jj_la1 = new int[280];
  ...
  public SparqlCorese(java.io.InputStream stream, String encoding) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 280; i++) jj_la1[i] = -1;
