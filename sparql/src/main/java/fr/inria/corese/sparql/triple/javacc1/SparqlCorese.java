...
// by expanding out FunctionCall()
 ...
 Exp stack; Token t = null; Function term;   ExpressionList v; Constant cst; Expression body;
  ...
  private int jj_gen;
  final private int[] jj_la1 = new int[320];
  ...
  public SparqlCorese(java.io.InputStream stream, String encoding) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 320; i++) jj_la1[i] = -1;
