...
// << s p o >> q v .
 ...
 Variable refvar = null; Atom sub, obj, ref, pred;  Triple t;
    jj_consume_token(LT);
    jj_consume_token(LT);
    sub = StarTerm(stack);
    pred = Verb();
    ...
    default:
      ...
      ;
          ...
          ref = astq.createTripleReference(refvar, isLoad()) ;
