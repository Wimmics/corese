...
public class ParserHandler {
    ...
    public Exp createTriples(ASTQuery ast, Exp stack, Expression subject, Atom predicate, ExpressionList objectList,
            int n)
    ...
    Exp createTripleWithAnnotation(ASTQuery ast, Exp stack, Atom subject, Atom predicate, Atom object)
        ...
        if (stack.isStack() && isTurtleLoader()) {
            ...
            // switch to sparql parser mode and create/record annotation Triple instead of
            // Edge
            // annotation Edge will be created from triple later by
            // processTurtleAnnotation()
            ...
            if (str.charAt(i) == '\\' && i + 1 < str.length()) {
                ...
                switch (str.charAt(i)) {
                    ...
                    default:
                        ...
                        // specified above, the backslash is left in the result string
                        retval.append('\\');
