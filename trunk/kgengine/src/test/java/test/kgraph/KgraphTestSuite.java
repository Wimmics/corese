...
//
//    public KgraphTestSuite(String Name_)
//
//    {
//        super(Name_);
//
...
//	"}" +
//	"group by ?x " +
//	"having (?c >= 50 && exists{?x c:FirstName ?n})";
//
...
//	"}";
//
//suite.addTest(new CoreseTest2(true, "testQuery", corese, query, 30));
//
//query = 
//	"select * where {" +
...
//    		  
//   query="select * where {" +
//    	 		"?x ?p ?y optional{?x current::?p ?z} filter(!bound(?z)) }";       		
//    	        		
//    suite.addTest(new CoreseTest2(true, "testQuery", corese, query, 0));
//    	        		  
//    		  
//    		  query="select * where {" +
//    	 		"?x current::c:FirstName '\"?Olivier\"' } " ;
//    	 		
//   suite.addTest(new CoreseTest2(true, "testQuery", corese, query, 1));
//    		  	  
//    		  
...
//          
//          suite.addTest(new CoreseTest2(true, "testQuery", corese, query, 2291));
//
// query =         "select distinct ?x  result 10000   where { ?x ?p ?l " +
//          "filter ( isLiteral(?l) ) }";         
//          
...
//      
//     suite.addTest(new CoreseTest2(true, "testQuery", corese,
//         "select    where {?x ?p ?src  graph ?src {?a ?q ?b}} group by ?x", 1));
//
////  suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//			suite.addTest(new CoreseTest2(true, "testQuery", corese,
//					"select * where { ?x c:Designation ?val  " +
//					"filter (?x = <http://www.inria.fr/> && ?val != 'http://www.inria.fr'@en )}", 2));
//			
//			
//			suite.addTest(new CoreseTest2(true, "testQuery", corese,
//					"select * where { ?x c:Designation ?val  " +
...
//      "{?y c:Include  ?x } filter(?x ~ 'corby')} ", 5));
//
//
// suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//
// suite.addTest(new CoreseTest2(true, "testQuery", corese,
// "select  where { rdfs:Class  rdf:type rdfs:Resource}", 1));
//
// suite.addTest(new CoreseTest2(true, "testQuery", corese,
//		 "select  where { rdfs:Class  rdf:type rdfs:Resource}", 1));
//
...
//"from  data2:f1.rdf from  data2:f2.rdf where {" +
//"graph ?graph {?x rdfs:seeAlso ?src}  " +
//"optional { ?y c:FamilyName 'Bernard' ?z c:FirstName 'Olivier' }}", 2));
//
//
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//"select    *  " +
...
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select more where {" +
//        "?x c:FirstName 'Olivier' optional {?x c:isMemberOf ?org}}", 16));
//
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//        "graph ?s {?x ?p ?y} filter( ?x ~ 'olivier.corby') } order by ?s", 6));
//
//
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//           " optional{  ?a ?p ?b } filter (! bound(?b)) }", 11));
//
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select distinct ?src     where {" +
...
//
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//       "select   where { ?a ?p ?a  ?p rdf:type ?class   }", 3));
//
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select   where {" +
...
//         " ?y ?q <http://www.inria.fr/olivier.corby> filter(  ?v = ?y)} ", 11));
//
//        //  direct access with constant
////          suite.addTest(new CoreseTest2(true, "testQuery", corese,
////        " select   * where {" +
...
//
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select  where {graph ?src {?x ?p ?src}}", 1));
//
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//        " filter (! bound(?class) && ! isLiteral(?y))}", 0));
//
//          suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//      "optional{?org c:Designation ?name} filter (! bound(?name))  }} } limit 200", 125));
//
//      suite.addTest(new CoreseTest2(true, "testQuery", corese,
//      "select ?x   where {?x c:IsInterestedBy ?topic " +
...
//        "select ?x  where {?x c:IsInterestedBy ?topic " +
//        "optional{?x c:isMemberOf ?org  optional {?org c:Designation ?name} " +
//        "filter (! bound(?name)  ) }} limit 200 ", 125));
//
//      suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//
//          suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select ?x where {?x c:FirstName ?name  ?x c:FamilyName ?fname filter( ?fname = 'Corby') " +
//        "optional{?x ?p ?y filter (! (?p ~ 'rdf')) }} ", 70));
//
//          suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//
//        suite.addTest(new CoreseTest2(true, mod, "testQuery", corese,
//        " select where {?x c:isMemberOf  <http://www-sop.inria.fr/> } ", 26));
//
////        suite.addTest(new CoreseTest2(true, mod, "testQuery", corese,
...
//
//          suite.addTest(new CoreseTest2(true, "testQuery", corese,
//          "select where { ?x c:test4 ?v  filter( ?v != 'abcdef'^^c:test )}", 1));
//
//          suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//        
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//      "select  where {?x c:isMemberOf ?org ?x rdf:type ?c} group by ?org   ?c", 64));
//        
//      suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//        " optional{?src c:date ?date} } group by ?src", 6));
//
//
//        if (true) {
//
...
// 
//         suite.addTest(new CoreseTest2(true, "testQuery", corese,
//          "select distinct ?src where {graph ?src { ?x c:IsInterestedBy ?topic}}", 10));
// 
//         suite.addTest(new CoreseTest2(true, "testQuery", corese, 
//        		 "select where {graph ?src {?p ?p ?x}}", 4));
// 
//         suite.addTest(new CoreseTest2(true, "testQuery", corese, 
...
////here
//        suite.addTest(new CoreseTest2(true, "testQuery", corese, 
//        "select distinct ?p  where { ?p ?r ?x  filter  isBlank(?p) } limit 200", 154));
//
//        suite.addTest(new CoreseTest2(true, "testQuery", corese, 
//        "select where {?p ?p ?x}", 4));
// 
...
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//       "select distinct sorted where { " +
//       "?p c:height ?i ?p c:height ?l   filter ( 2 * ?i +  ?l = ?l + 2 * ?i) }", 10));
// 
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//       "select distinct sorted where { " +
//       "?p c:height ?i ?p c:height ?l ?p c:height ?d  filter ( ?i +  ?l < ?d )}", 3));
//
////        suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//
//             suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select where {?x ?p 'http://www.inria.fr'}", 1));
//             
//             
// 
//             suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select where {?x ?p 'http://www.inria.fr'^^xsd:string}", 1));
//
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select where {?x ?p 'http://www.inria.fr'^^rdf:XMLLiteral}", 1));
//
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select where {?x ?p ?l   " +
...
// 
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select where { ?x ?p <http://www.inria.fr/acacia/comma#Person>}", 804));
//        
//        
//        
// 
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select where {?x rdf:type c:Person ?x c:age \"45\"^^xsd:integer  " +
...
//        "?p one::rdf:type ?c } group by ?c projection 1", 1));
//        
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select  where { ?p rdf:type c:Person " +
//        "?p one::rdf:type ?c } group by ?c limit 1", 1));
//        
//         
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select distinct ?p where { ?p rdf:type owl:TransitiveProperty    " +
//        "?x c:SomeRelation::?p ?y }",3));
//        
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
//        "select distinct ?p where { ?p rdf:type owl:TransitiveProperty   " +
//        "?p rdf:type ?c  ?x c:SomeRelation::?p ?y }",3));
//        
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//        "?doc c:Title ?t filter(?t ~ \"knowledge\") } ", 21));
//
//        suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//        "{?x rdf:type c:Person} union {?x rdf:type c:Organization}}", 15));
// 
//        suite.addTest(new CoreseTest2(true, "testQuery",corese,
...
//
//        suite.addTest(new CoreseTest2(true, "testQuery",corese,
//     "select where { ?x rdf:type c:Person  ?x c:FamilyName \"Corby\" } ", 5));
//        
//        
//        
//        
...
//        "optional{?x c:IsInterestedBy ?t}   ?t rdf:type c:JavaProgrammingTopic }", 10));
//
//        suite.addTest(new CoreseTest2(true,"testQuery", corese,
//        "select where { ?x rdf:type c:Person  ?x c:SomeRelation ?y " +
//        "filter(datatype(?y) = xsd:string)   filter(?y ~ \"x\") }", 23));
//
//        // here **
//   suite.addTest(new CoreseTest2(true, "testQuery", corese,
...
//
//          suite.addTest(new CoreseTest2(true, "testQuery", corese,
//     "select where { ?doc c:CreatedBy ?p  ?doc c:Title ?title  ?p rdf:type c:Person " +
