...
public class And {
    ...
    public fr.inria.edelweiss.rif.ast.And<fr.inria.edelweiss.rif.api.IFormula> XML2AST() {
    	fr.inria.edelweiss.rif.ast.And<fr.inria.edelweiss.rif.api.IFormula> and = fr.inria.edelweiss.rif.ast.And.create() ;
