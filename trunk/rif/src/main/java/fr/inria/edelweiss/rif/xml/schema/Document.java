 ...
 *         &lt;element ref="{http://www.w3.org/2007/rif#}directive" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.w3.org/2007/rif#}payload" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Document {
    ...
    public fr.inria.edelweiss.rif.ast.Group XML2AST(RIFDocument rifdoc) {
    	for(Directive dir : this.getDirective()) {
    		rifdoc.addImportedDocument(dir.getImport().getLocation().getConst().getContent().get(0),
    				                   dir.getImport().getProfile().getConst().getContent().get(0)) ;
    	}
    	return this.payload.XML2AST() ;
    }
