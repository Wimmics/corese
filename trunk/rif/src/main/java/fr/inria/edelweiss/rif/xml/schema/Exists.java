 ...
 *         &lt;element ref="{http://www.w3.org/2007/rif#}formula"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Exists {
    ...
    public fr.inria.edelweiss.rif.ast.Exists XMl2AST() {
    	Vector<fr.inria.edelweiss.rif.ast.Var> existentialVars = new Vector<fr.inria.edelweiss.rif.ast.Var>() ;
    	for(Declare dec : this.declare)
    		existentialVars.add(dec.XML2AST()) ;
    	return  fr.inria.edelweiss.rif.ast.Exists.create(existentialVars, this.formula.XML2AST()) ;
    }
